...
<body class="sticky-header">
	<section> <jsp:include page="menu.jsp"></jsp:include> <!-- main content start-->
					...
					<div class="row state-overview">
						<div class="col-md-6 col-xs-12 col-sm-6">
							<div class="panel purple">
								...
								<div class="state-value">
									<div class="value">${agent.totalHouseCardCount} 名</div>
						...
						<div class="col-md-6 col-xs-12 col-sm-6">
							<div class="panel blue">
								...
								<div class="state-value">
									<div class="value">${agent.curHouseCardCount} 名</div>
