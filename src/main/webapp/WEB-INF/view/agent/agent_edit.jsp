                ...
                <form id="agentForm" class="form-horizontal adminex-form" action="" method="post">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                        	<c:if test="${subordinateAgent.AgentLevel==1}"><p class="form-control-static">地区代理</p></c:if>
                        	<c:if test="${subordinateAgent.AgentLevel==2}"><p class="form-control-static">二级代理</p></c:if>
                        	<c:if test="${subordinateAgent.AgentLevel==3}"><p class="form-control-static">三级代理</p></c:if>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" name="AgentCount" id="disabledInput" 
